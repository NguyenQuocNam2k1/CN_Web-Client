...
>>>>>>> d10e6f167b716b9556cbc12170fa97e20366aa3c
            ...
            <div className="col-3 footer-title">
              ...
              <ul>
                ...
                <li className="footer-list">Codecademy</li>
              </ul>
            </div>
            ...
            <div className="col-3 footer-title">
              ...
              <ul>
                <li>
                  ...
                  <span className="footer-list">Đại học Kinh tế Quốc dân</span>
                </li>
                <li>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                  ...
                  <span className="footer-list">info@gmail.com</span>
                </li>
                <li>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                  ...
                  <span className="footer-list">+84 123456789</span>
                </li>
              </ul>
            </div>
          </div>
