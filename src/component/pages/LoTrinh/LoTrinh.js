        ...
        <div className="container lo-trinh">
            <div className="row">
                ...
                <div className="lt-list">
                    <div className="col-12 col-lg-8 col-xxl-8">
                        <div className="card mb-3 lt-card">
                            <div className="row g-0">
                                <div className="col-12 col-sm-6 col-sm-6 col-lg-8 col-xxl-5 lt-img">
                                    <img src={homeBegin} className="img-fluid rounded-start pe-5" alt="..."></img>
                                </div>
                                <div className="col-12 col-sm-4 col-lg-4 pe-lg-5 col-xxl-7 lt-card-body">
                    ...
                    <div className="card mb-3 lt-card">
                        <div className="row g-0">
                            <div className="col-12 col-sm-6 col-lg-8 col-xxl-5 lt-img">
